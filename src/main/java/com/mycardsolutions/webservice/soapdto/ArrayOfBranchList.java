...
/**
 * <p>Java class for ArrayOfBranchList complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BranchList" type="{Smartsoft.Integration.Services}BranchList" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ArrayOfBranchList", propOrder = {
    "branchList"
})
public class ArrayOfBranchList {

    @XmlElement(name = "BranchList", nillable = true)
